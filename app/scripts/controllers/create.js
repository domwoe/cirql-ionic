...
angular.module('cirqlApp')
    .controller('CreateCtrl', ['$scope', '$state', '$rootScope', 'user', 'simpleLogin', '$location', 'fbutil', '$ionicSideMenuDelegate',
        function($scope, $state, $rootScope, user, simpleLogin, $location, fbutil, $ionicSideMenuDelegate) {
